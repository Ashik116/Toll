  ...
  Widget build(BuildContext context) {
    ...
    itemGridList = [
      ...
      items(
        ...
        isDark,
        sharedPreferences.getBool('isAdmin') ||
            sharedPreferences.getBool('isChittagong'),
      ...
      items(
        ...
        isDark,
        sharedPreferences.getBool('isAdmin') ||
            sharedPreferences.getBool('isManikganj'),
        ManikganjReportPage(),
      ),
      items(
        'Netrokona',
      ...
      items(
        ...
        isDark,
        sharedPreferences.getBool('isAdmin') ||
            sharedPreferences.getBool('isTeesta'),
        TeestaReportPage(),
      ),
      items(
        'Mohanonda',
        ...
        isDark,
        sharedPreferences.getBool('isAdmin') ||
            sharedPreferences.getBool('isMohanonda'),
        MohanondaReportPage(),
      ),
    ];
